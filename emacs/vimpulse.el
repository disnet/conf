...
;; 
;hello, world; - cw with a count doesn't work the same as Vim when the point
...
; Added by timd
;;;;;;;;;;;;;;;
(define-key viper-vi-global-user-map " " 'pager-page-down)
(define-key viper-vi-global-user-map "-" 'pager-page-up)
;;;;;;;;;;;;;;;
